                    ...
                    <div class="container mt-5">
                        <div class="row">
                                ...
                                <table class="table table-striped table-bordered">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th>Phone Number</th>
                                            <th>Care Plans</th>
                                            <th>Medication Requirements</th>
                                            <th>FamilyContacts</th>
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT username, FirstName, LastName, PhoneNumber, CarePlans, MedicationRequirements, FamilyContacts FROM patients LIMIT $offset, $itemsPerPage";
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>" . htmlspecialchars($row["CarePlans"]) . "</td>";
                                                echo "<td>" . htmlspecialchars($row["MedicationRequirements"]) . "</td>";
                                                echo "<td>" . htmlspecialchars($row["FamilyContacts"]) . "</td>";
                                                echo "<td>";
                                                if ($_SESSION['role'] === 'admin') {
                                                    echo "<a href='editmember.php?username=" . htmlspecialchars($row["username"]) . "' class='btn btn-primary'>Edit</a>";
                                                    }; 
                                                echo "<form method='POST' action='deletepatient.php'>";
                            ...
                            <div> 
								<?php
									if ($_SESSION['role'] === 'admin') {
                                                echo "<a href='addpatient.php' class='btn btn-primary'>Add Patient</a>";
												}; ?>
                            </div>
                        </div>
                    </div>
