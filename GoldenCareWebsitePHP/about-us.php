...
<head>
	...
	<title>Contact Us » Golden Care</title>
		...
		<main>
			<div class="main-content-wrapper">
				<div class="main-column-1">
					<article>
						<h1 class="no-margin">My Hobbies</h1>
						<h2>07/03/2024</h2>
						<p>A few of my favourite hobbies include reading books, watching movies and playing games. My
							idea of a peaceful Saturday morning involves a book and a hammock (as seen in this photo).
							Most recently when I went camping, I took this photo while reading The Book of Dust. This is
							a prequel to one of my favourite book series which I read a while ago and has since been
							made into a movie! I have yet to watch the movie but its on my list of movies to watch, so I
							will get around to it one day!</p>
						<p>I love watching movies but rarely have the time for it after work or university, it’s nice to
							sit with my cat, Pantheon, and watch a movie as I fall asleep after a long day but
							unfortunately this is not conductive to finishing the movies. Hence, I have a list of movies
							that I have to watch, mostly classic ‘must see’ movies, that I simply never got around to
							watching.</p>
						<p>If I have more energy at the end of the day, you will often find me at my PC gaming with
							friends online.</p>
					</article>
				</div>
				<div class="main-column-2">
					<img id="hobbies" class="images" src="./images/hobbies.jpg"
						alt="Image of someone readings a book in a hammock.">
				</div>
			</div>
		</main>
		<aside>
				...
				<div class="aside-column-1">
					<section>
						...
						<ul>
							...
							<li>The Adventures and the Memoirs of Sherlock Holmes</li>
							<li>Rowan of Rin</li>
						</ul>
						<h3>Movies:</h3>
						<ul>
							<li>Iron Man</li>
							<li>Star Wars (all of them nested)</li>
							<li>Dune</li>
						</ul>
						<h3>Games:</h3>
						<ul>
						...
						<form id="book-survey" method="post"
							...
							<table id="book-survey-table">
									...
									<td>
										<p>
											<label>Northern Lights
												<input type="checkbox" name="Northern Lights">
											</label>
										</p>
									</td>
								</tr>
								<tr>
									<td>
										<p>
											<label>The Subtle Knife
												<input type="checkbox" name="The Subtle Knife">
											</label>
										</p>
									</td>
								</tr>
								<tr>
									<td>
										<p>
											<label>The Amber Spyglass
												<input type="checkbox" name="The Amber Spyglass">
											</label>
										</p>
									</td>
								</tr>
								<tr>
									<td>
										<p>
											<label>The Book of Dust
												<input type="checkbox" name="The Book of Dust">
											</label>
										</p>
									</td>
								</tr>
								<tr>
									<td>
										<p>
											<label>The Adventures and the Memoirs of Sherlock Holmes
												<input type="checkbox"
													name="The Adventures and the Memoirs of Sherlock Holmes">
											</label>
										</p>
									</td>
								</tr>
								<tr>
									<td>
										<p>
											<label>Rowan of Rin
												<input type="checkbox" name="Rowan of Rin">
											</label>
										</p>
									</td>
								</tr>
