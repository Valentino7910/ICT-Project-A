                        ...
                        <div class="row">
							...
							<table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT id, name, email, phone, date, time, service_type, username FROM bookings LIMIT $itemsPerPage OFFSET $offset";


                                        $countSql = "SELECT COUNT(id) AS total FROM bookings ";
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td><form method='POST' action='deletebooking.php'>";
